...
$query_raw = mysqli_query( $con,
    ...
    # Only with admin0
    -- 
    SELECT  a0.grid_id, a0.name, lg0.level_name, count(lg0.grid_id)
    ...
    # Has admin2
    -- 
    SELECT a0.grid_id, a0.name, lg2.level_name, count(lg2.grid_id) 
...
foreach ( $query as $country ) {
    ...
    foreach( $query as $result ) {
        ...
        $features[] = array(
            ...
            "properties" => array(
                "grid_id" => $result['grid_id'],
                "level" => $result['level'], // max levels available for this country
