...
$dtlg = 'dt_location_grid';

// define database connection
if ( ! file_exists( 'connect_params.json') ) {
    $content = '{"host": "","username": "","password": "","database": "", "output_path": ""}';
...
$output_directory = $params['output_path']; // polygons single
if( ! is_dir( $output_directory ) ) {
    mkdir( $output_directory, 0755, true);
}
$simplify_directory = $output_directory . 'simplified_output/';
if( ! is_dir( $simplify_directory ) ) {
    mkdir( $simplify_directory, 0755, true);
}
