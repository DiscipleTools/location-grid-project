...
foreach ( $break_down as $value ) {
    ...
    $content .= '|' . $value['name'] .'|' . $value['admin0_code'] .'|' . $value['level_name'] .'|' . $value['count'] .'|' . '['.strtolower( $value['admin0_code'] ).'_'.strtolower( $value['level_name'] ) .'.geojson](https://storage.googleapis.com/location-grid-mirror/gis/'.strtolower( $value['admin0_code'] ).'_'.strtolower( $value['level_name'] ) .'.geojson) |'  . PHP_EOL;
}
